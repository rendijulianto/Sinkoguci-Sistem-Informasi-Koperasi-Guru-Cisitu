...
<form class="row mb-4" method="GET" action="{{route('petugas.laporan.transaksi')}}">
    <div class="col-6">
...
<div class="row mb-4">
    <div class="col-12 mb-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card_title">
                    Data Transaksi Pembayaran | Tanggal : {{$tgl}}
                </h4>
                            ...
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th class="text-right">Petugas <i  class="fa fa-info-circle"
                                        ...
                                        data-toggle="tooltip" data-placement="top" title="Petugas yang melakukan transaksi"></i></th>
