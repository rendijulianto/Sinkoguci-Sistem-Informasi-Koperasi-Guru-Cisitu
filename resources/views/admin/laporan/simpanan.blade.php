...
<form class="row mb-4" method="GET" action="{{route('admin.laporan.simpanan-bulanan')}}">
    <div class="col-3">
    ...
    <div class="col-lg-3 mt-3">
        <a href="{{route('admin.laporan.simpanan-bulanan')}}?bulan={{$bulan}}&tahun={{$tahun}}&id_sekolah={{$id_sekolah}}&aksi=download" class="btn btn-success btn-block" target="_blank">Download Excel <i class="fa fa-file-excel"></i></a>
    </div>
    @endif
</div>
<div class="row mb-4">
