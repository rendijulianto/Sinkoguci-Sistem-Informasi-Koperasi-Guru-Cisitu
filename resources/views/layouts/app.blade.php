...
<html lang="en">
   <head>
      ...
      <title>
        {{-- issset jika ada content maka masuk --}}
         @isset($title)
             {{$title}} | Sinkoguci
         @else
               Sinkoguci
      ...
      <div class="wrapper">
         <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
               ...
               <span class="align-middle">Sinkoguci</span>
               </a>
               ...
               <ul class="sidebar-nav">
                  ...
                  <li class="sidebar-item">
                     <a class='sidebar-link' href='/pages-profile'>
                     <i class="align-middle" data-feather="dollar-sign"></i> <span class="align-middle">Kelola Simpanan</span>
                     </a>
                  </li>
                  <li class="sidebar-item">
                     <a class='sidebar-link' href='/pages-profile'>
                     <i class="align-middle text-red" data-feather="dollar-sign"></i> <span class="align-middle">Kelola Penarikan</span>
                     </a>
                  </li>
                  <li class="sidebar-item">
                     <a class='sidebar-link' href='/pages-sign-in'>
                     <i class="align-middle" data-feather="credit-card"></i> <span class="align-middle">Kelola Pinjaman</span>
                     </a>
                  </li>
                  <li class="sidebar-item">
                     <a class='sidebar-link' href='/pages-sign-in'>
                     <i class="align-middle" data-feather="plus-circle"></i> <span class="align-middle">Kelola Angsuran</span>
                     </a>
                  </li>
                  <li class="sidebar-item">
                     <a class='sidebar-link' href='/pages-sign-in'>
                     <i class="align-middle" data-feather="check-square"></i> <span class="align-middle">Cek Data Peminjaman</span>
                     </a>
                  </li>
                  <li class="sidebar-header">
                     Data Master
                  ...
                  <li class="sidebar-item">
                     <a class='sidebar-link' href='/pages-sign-in'>
                     <i class="align-middle" data-feather="users"></i> <span class="align-middle">Kelola Anggota</span>
                     </a>
                  </li>
               </ul>
