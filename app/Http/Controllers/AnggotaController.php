...
class AnggotaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $title = 'Data Anggota';
        $anggota = Anggota::where('nama', 'like', '%' . $request->cari . '%')->orderBy('id_anggota', 'DESC')->paginate(10);
        if ($filterSekolah) {
            $anggota = Anggota::where('id_sekolah', $filterSekolah)->orderBy('id_anggota', 'DESC')->paginate(10);
        }
